...
<head>
<meta charset="utf-8" />
<title>@yield('title') - Tours and Travels Online Booking HTML</title>
...
<!--srart theme style -->
<link href="{{ url('user/css/main.css') }}" rel="stylesheet" type="text/css"/>
<!-- end theme style -->
<!-- favicon links -->
 ...
 <div class="travel_loading_bar_wrapper">
     <div class="travel_loading_bar">
         ...
         <div class="travel_loading_bar_overlay" style="width:0%;">
             <span class="pointer"><img src="{{ url('user/images/icon/loading_plane.svg') }}" alt="" /></span>
