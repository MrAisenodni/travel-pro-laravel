				  ...
				  <div id="rev_slider_116_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
					  <ul style="width:100% !important;">
						  ...
						  <li data-index="rs-391" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
							  <!-- MAIN IMAGE -->
							  <img src="http://placehold.it/1600x1060" alt="slide2" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							  <!-- LAYERS -->
							  ...
							  <div class="tp-caption NotGeneric-Title   tp-resizeme" 
									...
									<div style="font-size:36px; line-height:45px;" class="Travelite_slider_text"> once a year</div>
									<div style="font-size:40px; line-height:45px;" class="Travelite_slider_text"> Go SomePlace</div>
									<div style="font-size:30px; line-height:45px;" class="Travelite_slider_text"> You’ve Never</div>
									<div style="font-size:48px; line-height:45px;" class="Travelite_slider_text bottom_line_text"> Been Before</div>
							 ...
							 >
							 <div class="tour_packages" style="font-size:26px;">Tour Packages Starts@ <span style="font-size:38px;">$260</span></div>
						  ...
						  <li data-index="rs-392" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide Mask" data-description="">
							  <!-- MAIN IMAGE -->
							  <img src="http://placehold.it/1600x1060" alt="slide3" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							  <!-- LAYER NR. 1 -->
							 <div class="slider_heading_wrap">
							  <!-- LAYER NR. 1 -->
							  <div class="tp-caption NotGeneric-Title   tp-resizeme" 
							 ...
							 <div class="tour_packages" style="font-size:26px;">Tour Packages Starts@ <span style="font-size:38px;">$260</span></div>
							   ...
							   <!-- LAYER NR. 2 -->
								  ...
								  <!-- LAYER NR. 3 -->
								  <div class="slider_buttons tp-caption NotGeneric-Title slideheading  tp-resizeme" id="slide-392-layer-3" data-x="680" data-y="center" data-voffset="80" 
										data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" 
									 data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
									  data-start="3000" 
									data-splitin="none" 
			  ...
			  <div class="row">
					  ...
					  <div class="feature_box_second">
					   <img src="http://placehold.it/270x264" class="img-responsive" alt="feature">
						  <div class="feature_overlay_second">
							   <div class="bottom_first"><a href="Tour-Packages-Details.html">Australia</a><span>(770 Places)</span></div>
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6">
					  <div class="feature_box_second">
					   <img src="http://placehold.it/270x264" class="img-responsive" alt="feature">
						  <div class="feature_overlay_second">
							   <div class="bottom_first"><a href="Tour-Packages-Details.html">greece</a><span>(520 Places)</span></div>
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6">
					  <div class="feature_box_second">
					   <img src="http://placehold.it/270x264" class="img-responsive" alt="feature">
						  <div class="feature_overlay_second">
							   <div class="bottom_first"><a href="Tour-Packages-Details.html">paris</a><span>(350 Places)</span></div>
							   <div class="bottom_second">start from <span>$350</span></div>
							</div>
					  </div>
				  </div>
