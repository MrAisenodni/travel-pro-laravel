...
<meta name="keywords" content="Travel Pro Template">
...
<!-- end theme style -->
<!-- favicon links -->
<link rel="shortcut icon" type="image/ico" href="{{ url('user/favicon.ico') }}" />
<link rel="icon" type="image/ico" href="{{ url('user/favicon.ico') }}" />
</head>
 ...
 <div class="travel_loading_bar_wrapper">
     <div class="travel_loading_bar">
         ...
         <div class="travel_loading_bar_overlay" style="width:0%;">
             <span class="pointer"><img src="user/images/icon/loading_plane.svg" alt="" /></span>
				  ...
				  <div id="rev_slider_116_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
					  <ul style="width:100% !important;">
						  ...
						  <li data-index="rs-391" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Smooth Mask" data-description="">
							  <!-- MAIN IMAGE -->
							  <img src="http://placehold.it/1600x670" alt="slide2" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							  <!-- LAYERS -->
							  <!-- LAYER NR. 1 -->
							  <div class="slider_left_part">
								  ...
								  style=" z-index: 8;">
									  <h4 style="font-size:20px;">Enjoy a grand trip</h4>
									  <h3 style="font-size:30px;">Around the world</h3>
									  <p style="font-size:13px; line-height:15px; border-bottom:1px solid #333333;padding-bottom: 19px;">Get ready for the new adventure with Travellers, Travellers<br/>
									  works hard to secure the best hotel rates in the most popular<br/>
										destinations.</p>
						  ...
						  <li data-index="rs-392" data-transition="parallaxhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate="0" data-saveperformance="off" data-title="Slide Mask" data-description="">
							  <!-- MAIN IMAGE -->
							  <img src="http://placehold.it/1600x670" alt="slide3" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							  <!-- LAYER NR. 1 -->
							  <div class="slider_left_part">
			...
			<div class="row">
				...
				<div class="heading_team">
					...
					<p>Create stunning pages with our powerful admin panel. Functionality and usability combine. Travelllers Deals and Offers on Hotels, Vacation Packages, Flights, Cruises and Car Rentals</p>
						...
						<div class="full_width rectangle_wrapper">
					       ...
					       <div class="col_25 ractangle_box_cover">
							...
							<i class="fa fa-soundcloud big_circle"></i>
							</div>
							<div class="full_width ractangle_inner">
							<img src="http://placehold.it/170x250" alt="house">
					...
					<!-- first ractangle End -->
							...
							<div class="col_25 ractangle_box_cover">
								<div class="circle_icon">
								<i class="fa fa-home big_circle"></i>
								</div>
								<div class="full_width ractangle_inner">
									<img src="http://placehold.it/170x250" alt="house">
									<div class="inner_ovelay">
										<h4>boat house</h4>
										<p>7 tours available</p>
									</div>
								</div>
								<div class="circle_icon">
									<a href="#" class="fa fa-arrow-right small_circle"></a>
								</div>
							</div>
							...
							<div class="col_25 ractangle_box_cover">
								<div class="circle_icon">
									<i class="fa fa-paw big_circle"></i>
								</div>
								<div class="full_width ractangle_inner">
									<img src="http://placehold.it/170x250" alt="house">
									<div class="inner_ovelay">
										<h4>adventure tours </h4>
										<p>10 tours available</p>
									</div>
								</div>
								<div class="circle_icon">
									<a href="#" class="fa fa-arrow-right small_circle"></a>
							...
							<div class="col_25 ractangle_box_cover">
								<div class="circle_icon">
									<i class="fa fa-birthday-cake big_circle"></i>
								</div>
								<div class="full_width ractangle_inner">
									<img src="http://placehold.it/170x250" alt="house">
									<div class="inner_ovelay">
							...
							<div class="col_25 ractangle_box_cover">
								<div class="circle_icon">
									<i class="fa fa-pied-piper-alt big_circle"></i>
								</div>
								<div class="full_width ractangle_inner">
									<img src="http://placehold.it/170x250" alt="house">
									<div class="inner_ovelay">
										<h4>wing ride in forest </h4>
										<p>8 tours available</p>
									</div>
								</div>
								<div class="circle_icon">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <aside class="widget widget_text"> 
			<a href="Home_01.html"><img src="svg/Logo.svg" alt="footer logo" />
			</a> 
	 ...
	 xml:space="preserve">
		...
		L24.1,23.386l-0.058,0.126l-0.039,0.084C24.004,23.596,24.017,23.595,24.042,23.59z"/>
                ...
                <li><a href="#widget_hotal_search"> <svg version="1.1" id="widget_hotal_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
			...
			/>
                ...
                <li><a href="#widget_flight_search"> <svg version="1.1" id="widget_flight_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 375.04 375.04" style="enable-background:new 0 0 375.04 375.04;" xml:space="preserve">
			...
			c0,0-1.113-5.204,2.023-8.592c11.238-12.143,44.842-48.672,44.842-48.672C370.692,58.334,384.83,25.368,365.938,8.173z"/>
                ...
                <li><a href="#widget_local_search"> <svg version="1.1" id="widget_local_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 ...
	 xml:space="preserve">
		...
		C93.388,284.317,84.397,275.327,84.397,264.278z"/>
          ...
          <aside class="widget payment_method">
            ...
            <a href=""><img src="user/images/Payment-Images.png" alt="Payment Method" /></a> </aside>
        </div>
      </div>
    </div>
  </footer>
...
<script type="text/javascript" src="user/js/bootstrap-select.js"></script> 
<script type="text/javascript" src="user/js/plugin/datetimepicker/jquery.datetimepicker.js"></script> 
<script type="text/javascript" src="user/js/plugin/parallax/jquery.parallax-1.1.3.js"></script> 
<script type="text/javascript" src="user/js/plugin/owl/owl.carousel.js"></script> 
<script type="text/javascript" src="user/js/plugin/isotope/jquery.isotope.js"></script> 
<script type="text/javascript" src="user/js/plugin/bxslider/jquery-bxslider.js"></script> 
<!-- pie chart js -->
<script type="text/javascript" src="user/js/plugin/pie-circle/circles.js"></script> 
<!-- pie chart js -->
<!--counter js-->
<script type="text/javascript" src="user/js/plugin/counter/jquery.countTo.js">
</script>
 <!--counter js-->
<script type="text/javascript" src="user/js/plugin/counter/jquery.countdown.js">
</script>
	<!-- REVOLUTION JS FILES -->
    <script type="text/javascript" src="user/js/plugin/revolution/js/jquery.themepunch.tools.min.js">
    </script>
    <script type="text/javascript" src="user/js/plugin/revolution/js/jquery.themepunch.revolution.min.js">
    </script>
    <script type="text/javascript" src="user/js/plugin/revolution/js/revolution.extension.layeranimation.min.js">
    </script>
    <script type="text/javascript" src="user/js/plugin/revolution/js/revolution.extension.navigation.min.js">
    </script>
    <script type="text/javascript" src="user/js/plugin/revolution/js/revolution.extension.slideanims.min.js">
    </script>
    <script type="text/javascript" src="user/js/plugin/revolution/js/revolution.extension.actions.min.js">
    </script>
    <script type="text/javascript" src="user/js/plugin/revolution/js/revolution.extension.parallax.min.js">
    </script>
    <!-- REVOLUTION JS FiLES -->
	<!-- video_popup -->
	<script type="text/javascript" src="user/js/plugin/video-popup/jquery.magnific-popup.js">
    </script>
	<!-- video_popup -->
	<!-- slick slider -->
	<script type="text/javascript" src="user/js/plugin/slick/jquery-migrate-1.2.1.min.js">
    </script>
	<script type="text/javascript" src="user/js/plugin/slick/slick.min.js"></script>
	<!-- slick slider -->
	<!-- video player js -->
	<script src="user/js/plugin/video_player/mediaelement-and-player.min.js"></script>
	<!-- video player js -->
	<!-- pricefilter -->
	<script src="user/js/plugin/jquery-ui/jquery-ui.js"></script>
	<!-- pricefilter-->
